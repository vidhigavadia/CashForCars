...
error_log($post_data);
	...
	if(sizeof($GLOBALS['formErrors']) == 0) {
		...
		if(array_key_exists('address_line_1',$form_data)){
			$address = $form_data['address_line_1'][0];
			if(array_key_exists('address_line_2',$form_data)){
			$address .= $form_data['address_line_2'][0]
		...
		if(array_key_exists('vehicle_state',$form_data)){
		...
		if(array_key_exists('is_car_drivable',$form_data)){
		...
		if(array_key_exists('is_car_paid_for_entirely',$form_data)){
		...
		if(array_key_exists('how_did_you_hear_about_us',$form_data)){
